...
const FixWatermarkListItem = () => {
  ...
  return (
    <>
      <ListItem
        title={t('root.settings.fix-watermark')}
        media={<WatermarkIcon size={26} />}
        after={<Toggle checked={fixWatermark} onChange={() => setFixWatermark(!fixWatermark)} />}
      />

      {fixWatermark && (
        <ListInput
          floatingLabel
          label={t('root.settings.watermark')}
          type="text"
          value={watermark}
