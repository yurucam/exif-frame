      ...
      <Page>
        ...
        <List strongIos inset>
          <ListInput
            ...
            type="text"
            value={make}
            onChange={(e) => (setMake(e.target.value), (overrideMetadataTarget!.make = e.target.value))}
          />
          <ListInput
            label={t('model')}
            type="text"
            value={model}
            onChange={(e) => (setModel(e.target.value), (overrideMetadataTarget!.model = e.target.value))}
          />
          <ListInput
            label={t('lens')}
            type="text"
            value={lens}
            onChange={(e) => (setLens(e.target.value), (overrideMetadataTarget!.lensModel = e.target.value))}
          />
          <ListInput
            label={t('focal')}
            type="text"
            value={focal}
            onChange={(e) => (setFocal(e.target.value), (overrideMetadataTarget!.focalLength = e.target.value))}
          />
          <ListInput
            label={t('aperture')}
            type="text"
            value={aperture}
            onChange={(e) => (setAperture(e.target.value), (overrideMetadataTarget!.fNumber = e.target.value))}
          />
          <ListInput
            label={t('iso')}
            type="text"
            value={iso}
            onChange={(e) => (setIso(e.target.value), (overrideMetadataTarget!.iso = e.target.value))}
          />
          <ListInput
            label={t('shutter')}
            type="text"
            value={shutter}
            onChange={(e) => (setShutter(e.target.value), (overrideMetadataTarget!.exposureTime = e.target.value))}
          />
        </List>
      </Page>
    </Popup>
